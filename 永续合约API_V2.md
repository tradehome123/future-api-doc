...
- 请求类型: POST
- 请求参数:
- 限频: 当市价单委托时5次/秒，其他按默认的限频规则

| 名称          | 类型       | 是否必须 | 描述                                                         |
| :------------ | :--------- | :------- | :----------------------------------------------------------- |
| symbol        | String     | 是       | 交易对，如：BTC_USDT                                         |
| action        | Integer    | 否       | 订单价格类型:  <br/>1   限价<br/>11 对手价<br/>12 最优5档<br/>13 最优10档<br/>14 最优20档<br/>19 最优极限档，即在限价上限或下限的最优价格<br/>2  市价（按数量委托）<br/>3   IOC<br/>31 对手价IOC<br/>32 最优5档IOC<br/>33 最优10档IOC<br/>34 最优20档IOC<br/>39 最优极限档IOC，即在限价上限或下限的最优价格IOC<br/>4   只做 maker<br/>5   FOK<br/>51 对手价FOK<br/>52 最优5档FOK<br/>53 最优10档FOK<br/>54 最优20档FOK<br/>59 最优极限档FOK，即在限价上限或下限的最优价格FOK<br/>默认是1 |
...
| action       | 否   | Integer | 类型，1: 限价，2:市价，默认为1                               |
| algoPrice    | 否   | Decimal | 委托价格，填写值0\<X\<=1000000，当action=2时为空，否则不能为空 |
...
| action       | 否   | Integer | 类型，1: 限价，2:市价，默认为1                               |
| algoPrice    | 否   | Decimal | 委托价格，填写值0\<X\<=1000000，当action=2时为空，否则不能为 |
| ~~bizType~~  | 否   | Integer | `1`:止盈<br/>`2`:止损<br/>弃用                               |
...
| ~~bizType~~  | 是   | Integer | `1`:止盈<br/>`2`:止损<br/>弃用                               |
| action       | 否   | Integer | 委托类型，1: 限价，2:市价，默认为1，止盈止损才用到的属性     |
| leverage     | 是   | Integer | 杠杠倍数                                                     |
| sourceType   | 是   | Integer | 来源：<br/>1:WEB<br/>2:Android<br/>3:iOS<br/>4:Rest API<br/>5:WebSocket API<br/>6:System<br/>7:Plan Entrust(计划委托)<br/>8:Take Profit(止盈)<br/>9:Stop Loss(止损) |
| canCancel    | 是   | Boolean | 能否取消                                                     |
...
- **特有的参数：**
  ...
  | price         | 是   | Decimal | 价格                                                         |
  | amount        | 是   | Decimal | 数量                                                         |
  | actionType    | 是   | Integer | 订单价格类型:  <br/>1   限价<br/>11 对手价<br/>12 最优5档<br/>13 最优10档<br/>14 最优20档<br/>19 最优极限档，即在限价上限或下限的最优价格<br/>2  市价（按数量委托）<br/>3   IOC<br/>31 对手价IOC<br/>32 最优5档IOC<br/>33 最优10档IOC<br/>34 最优20档IOC<br/>39 最优极限档IOC，即在限价上限或下限的最优价格IOC<br/>4   只做 maker<br/>5   FOK<br/>51 对手价FOK<br/>52 最优5档FOK<br/>53 最优10档FOK<br/>54 最优20档FOK<br/>59 最优极限档FOK，即在限价上限或下限的最优价格FOK<br/>默认是1 |
  | side          | 是   | Integer | 方向：<br/>**双向持仓**<br/>1 开多（买入）<br/>2 开空（卖出）<br/>3 平多（卖出）<br/>4 平空（买入）<br/>**单向持仓**<br/>5 买入<br/>6 卖出<br/>0 仅平仓 |
...
```json
{
  ...
  "orderDatas": [
    {"symbol":"ETH_USDT","amount":1,"side":1,"price":"1100","action":1, "orderCode": "test01"},	
    {"symbol":"ETH_USDT","amount":1,"side":1,"price":"1000","action":1, "orderCode": "test02"}
  ]
}
```
